...
from . models import MenuItem, Category, OrderModel, Product, Cart, Customer, ReservationModel, OrderPlaced, RedemptionOption, Ad
...
class CustomerModelAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'mobile','points']
